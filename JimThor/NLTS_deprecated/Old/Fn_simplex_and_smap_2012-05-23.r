...
NltsPred = function(Y, PredInterval, Nembed, PredNum, Method, Theta=NA){
...
NltsFn = function(Y, PredInterval, Nembed, Theta=NA, Method){
...
EmbedFn = function(Y, PredInterval, Candidates=1:5){
...
ThetaFn = function(Y, PredInterval, ThetaSet=c(0,exp(seq(-3,3))), Nembed){
