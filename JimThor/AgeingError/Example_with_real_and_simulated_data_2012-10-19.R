...
SourceFile = "C:\\Users\\James Thorson\\Desktop\\UW Hideaway\\Ageing error\\Distribution\\"
  source(paste(SourceFile,"Fn_Run_and_plot_model_2012-10-19.r",sep=""))
  source(paste(SourceFile,"Fn_Simulate_data_2012-10-19.r",sep=""))
  source(paste(SourceFile,"Fn_stepwise_model_builder_2012-10-19.r",sep=""))
